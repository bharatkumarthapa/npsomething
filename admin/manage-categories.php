...
<td><a href="edit-category.php?cid=<?php echo htmlentities($row['id']);?>">edit</a> 
	&nbsp;<a href="manage-categories.php?rid= c<?php echo htmlentities($row['id']);?>&&action=del" class="btn-danger">delete</a> </td>
</tr>
<?php
$cnt++;
 } ?>
...
<td><?php echo htmlentities($row['PostingDate']);?></td>
<td><?php echo htmlentities($row['UpdationDate']);?></td>
<td><a href="manage-categories.php?resid=<?php echo htmlentities($row['id']);?>">restore</a> 
	&nbsp;<a href="manage-categories.php?rid=<?php echo htmlentities($row['id']);?>&&action=parmdel" title="Delete forever" class="btn-danger">delete</td>
</tr>
<?php
$cnt++;
 } ?>
