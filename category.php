...
<html lang="en">
  ...
  <body>
   ...
   <?php include('includes/header.php');?>
    ...
    $query=mysqli_query($con,"select posts.id as pid,posts.PostTitle as posttitle,posts.PostImage,category.CategoryName as category,subcategory.Subcategory as subcategory,posts.PostDetails as postdetails,posts.PostingDate as postingdate,posts.PostUrl as url from posts left join category on category.id=posts.CategoryId left join  subcategory on  subcategory.SubCategoryId=posts.SubCategoryId where posts.CategoryId='".$_SESSION['catid']."' and posts.Is_Active=1 order by posts.id desc LIMIT $offset, $no_of_records_per_page");
